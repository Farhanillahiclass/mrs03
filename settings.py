...
INSTALLED_APPS = [
    ...
    'apps.volunteers',
    'apps.whatsapp',
    'apps.core', # New app for landing page
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='muslim_revive_skills'),
...
# CORS Settings (To allow your frontend fetch calls if running separately)
